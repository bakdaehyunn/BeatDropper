...
public enum NativeFileImporter {
    @MainActor
    public static func openAudioFiles() -> [URL] {
    ...
    @MainActor
    public static func openReplacementAudioFile() -> URL? {
        let panel = NSOpenPanel()
    ...
    @MainActor
    public static func openMusicFolder() -> URL? {
        let panel = NSOpenPanel()
    ...
    public static func importTracks(from urls: [URL]) async -> [ImportedTrack] {
    ...
    public static func importFolder(_ folderURL: URL) async -> [ImportedTrack] {
    ...
    public static func classifyOpenURLs(_ urls: [URL]) -> NativeOpenImportSelection {
    ...
    public static func importTrack(from url: URL) async -> ImportedTrack? {
